    ...
    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
        ...
        <div>
            <a class="navbar-brand brand-logo" href="index.html">
                <!-- <h3 class="welcome-text m-0">
            <span class="text-primary fw-bold">Absolute</span></h3> -->
                <img src="images/logo.png" alt="">
            </a>
            <a class="navbar-brand brand-logo-mini" href="index.html">
                <img src="{{ asset('assetsimages/logo-mini.png') }}" alt="logo" />
            </a>
        </div>
    </div>
    <div class="navbar-menu-wrapper d-flex align-items-top">
        <h2 class="welcome-text m-0"><span class="text-black fw-bold">Dashboard</span></h2>
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                <a class="nav-link" id="UserDropdown" href="#" data-bs-toggle="dropdown"
                    aria-expanded="false">
                    <img class="img-xs rounded-circle" src="{{ asset('assetsimages/faces/face8.jpg') }}"
                        alt="Profile image"> </a>
