                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <i class="menu-icon mdi mdi-email-outline"
                                                    ...
                                                    data-bs-target="#edit" data-whatever="@mdo"></i>
                        ...
                        <div class="col-lg-12 text-end">
                            <div class="d-sm-flex align-items-center justify-content-between">
                                ...
                                <div class="right">
                                    ...
                                    <div class="modal fade" id="invoice" tabindex="-1" aria-labelledby="ModalLabel"
                                                ...
                                                <div class="modal-body">
                                                    <form class="row text-left">
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item">
                                                                <a class="nav-link active" id="tab-one"
                                                                    data-bs-toggle="tab" href="#in-one" role="tab"
                                                                    aria-controls="one" aria-selected="false">Customer</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link" id="tab-two" data-bs-toggle="tab"
                                                                    href="#in-two" role="tab" aria-controls="two"
                                                                    aria-selected="false">Services</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link " id="tab-three" data-bs-toggle="tab"
                                                                    href="#in-three" role="tab" aria-controls="three"
                                                                    aria-selected="true">Address</a>
                                                            </li>
                                                            <li class="nav-item">
                                                                <a class="nav-link " id="tab-four" data-bs-toggle="tab"
                                                                    href="#in-four" role="tab" aria-controls="four"
                                                                    aria-selected="true">Preview</a>
                                                            </li>
                                                        </ul>
                                                        <div class="tab-content">
                                                            <div class="tab-pane fade active show" id="in-one"
                                                            ...
                                                            <div class="tab-pane fade" id="in-two" role="tabpanel"
                                                            ...
                                                            <div class="tab-pane fade " id="in-three" role="tabpanel"
                                                                ...
                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade active show" id="inner-one"
                                                                        role="tabpanel" aria-labelledby="tab-one">
                                                                        <div class="row">
                                                                            <div class="form-group col-6 text-start">
                                                                                <label for="message-text"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="form-group col-3 text-start m-0">
                                                            ...
                                                            <div class="tab-pane fade " id="in-four" role="tabpanel"
                                                                aria-labelledby="tab-four">
                                                                <div class="row">
                                                                    <div class="col-4">
                                                                        <div class="box-1 p-3 h-100"
                                                                            style="border-right: 1px solid #ebedf2;">
                                                                            <span class="text-black fw-bold d-flex"><i
                                                                                    class="menu-icon mdi mdi-google-maps me-2"
                                                                                    style="font-size: 24px;"></i>Delivery
                                                                                Address</span>
                                                                            <p>10 ANSON ROAD, INTERNATIONAL
