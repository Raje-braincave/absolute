                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="tab-one" data-bs-toggle="tab" href="#one-outer"
                                    role="tab" aria-controls="one" aria-selected="false">User Management</a>
                            </li>
                        </ul>
                                        ...
                                        <div class="d-sm-flex align-items-center justify-content-between">
                                            ...
                                            <div class="right">
                                                ...
                                                <button type="button" class="btn btn-primary btn-icon-text"
                                                    ...
                                                    <i class="ti-plus btn-icon-prepend"></i> New User Management </button>
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form class="row text-left" method="POST" action="{{url('/addusermanagement')}}">
                                                                    @csrf
                                                                    <ul class="nav nav-tabs" role="tablist">
                                                                        <li class="nav-item">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><a href="{{'/deleteusermanagement',$management->id}}">Delete</a>
                                                            ||<a href="{{url('/vieweusermanagement',$management->id)}}">Edit</a>
                                                        </td>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
