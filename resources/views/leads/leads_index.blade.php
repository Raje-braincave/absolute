                                                        ...
                                                        <div id="step-1" class="tab-pane" role="tabpanel"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3 ps-0">
                                                                    ...
                                                                    <ul class="nav nav-pills nav-pills-success"
                                                                        ...
                                                                        <li class="nav-item">
                                                                            <a class="nav-link active" id="pills-home-tab"
                                                                                data-bs-toggle="pill"
                                                                                href="#residential-view" role="tab"
                                                                    ...
                                                                    <div class="tab-content" id="pills-tabContent"
                                                                        ...
                                                                        <div class="tab-pane fade show active"
                                                                            id="residential-view" role="tabpanel"
                                                                            aria-labelledby="pills-home-tab">
                                                                            <h5>Search By</h5>
                                                                            <div class="search-bar" style="width: 100%;">
                                                                                <input type="text" placeholder="Search">
                                                                                <i
                                                                                    class="search-icon text-muted mdi mdi-account-search"></i>
                                                                            </div>
                                                                            <div
                                                                                class="d-flex p-2 justify-content-between mt-3 border rounded">
                                                                                <div class="my-auto">
                                                                                    <label for="exampleInputEmail1"
                                                                                        class="mb-0 text-black fw-bold "
                                                                                        style="font-size: 14px">Will
                                                                                        Smith</label>
                                                                                    <p>Tel - +91 9825804569</p>
                                                                                </div>
                                                                                <div class="my-auto">
                                                                                    <span
                                                                                        class="badge badge-warning">Commercial</span>

                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="tab-pane fade" id="commercial-view"
                                                                            role="tabpanel"
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="my-auto">
                                                                                    <label for="exampleInputEmail1"
                                                                                        class="mb-0 text-black fw-bold "
                                                                                        style="font-size: 14px">John
                                                                                        Doe</label>
                                                                                    <p>Tel - +91-9737468988</p>
                                                                                </div>
                                                                                <div class="my-auto">
                                                                                    <span
                                                                                        class="badge badge-info">Residential</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <div class="col-md-9 pe-0">
                                                                    ...
                                                                    <div
                                                                        class="card box-shadow card-rounded text-left mt-3">
                                                                        <div class="card-body">
                                                                            <div class="row">
                                                                                <div class="col-md-3">
                                                                                    <label class="mb-0"
                                                                                        ...
                                                                                        <div class="productsubshow mt-3"
                                                                                            ...
                                                                                            <div class="table-responsive">
                                                                                                <table
                                                                                                    ...
                                                                                                    <tbody>
                                                                                                        <tr>
                                                                                                            <td><img class="img-xs rounded-circle"
                                                                                                            ...
                                                                                                            <td>
                                                                                                                <button
                                                                                                                    ...
                                                                                                                    type="button">
                                                                                                                    <i class="mdi mdi-plus menu-icon"
                                                                ...
                                                                <div class="col-md-3 ps-0">
                                                                    <div class="card box-shadow card-rounded text-left">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <label for="" class="mb-0">Customer
                                                                                Details</label>
                                                                            <p class="m-0"><i
                                                                                    class="mdi mdi-account menu-icon me-2"
                                                                                    style="font-size: 14px;"></i> Jhone Doe
                                                                            </p>
                                                                            <p class="m-0"><i
                                                                                    class="mdi mdi-phone-outline menu-icon me-2"
                                                                                    style="font-size: 14px;"></i>+91-9737155901
                                                                            </p>
                                                                            <p class="m-0"><i
                                                                                    class="menu-icon mdi mdi-google-maps me-2"
                                                                                    style="font-size: 14px;"></i>103
                                                                                Rasadhi Appartment Wadaj Ahmedabad
                                                                                380004.</p>
                                                                            <hr>
                                                                            <label for="" class="mb-0">Service
                                                                                Details</label>

                                                                            <p class="m-0">Floor Cleaning(5)</p>
                                                                            <p class="m-0">Home Cleaning(2)</p>
                                                                            <hr>
                                                                            <label for="" class="mb-0">Amount
                                                                                Details</label>
                                                                            ...
                                                                            <div class="tab-content"
                                                                                ...
                                                                                <div class="tab-pane fade active show"
                                                                                    ...
                                                                                    <div class="row" id="div"
                                                                                        style="display: none;">
                                                                                        <div
                                                                                            class="form-group col-md-4  text-start">
                                                                                            <label for="message-text"
                                                                                                class="col-form-label">Postal
                                                                                                Code</label>
                                                                                            <input type="text"
                                                                                                class="form-control"
                                                                                                id="recipient-name"
                                                                                    ...
                                                                                    <div class="d-flex mt-3"
                                                                                        ...
                                                                                        <div
                                                                                            class="form-group m-1 text-start m-0">
                                                                                            <div
                                                                                                class="address-card shadow">
                                                                                                <h5>Sky Enterprice</h5>
                                                                                                <p>8 Shopping Centre, 9
                                                                                                    Bishan Place, Singapore
                                                                                                    579837</p>
                                                                                                <div
                                                            ...
                                                            <div class="row">
                                                                    ...
                                                                    <div class="card box-shadow card-rounded text-left">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <p class="m-0">BLK 3017 BEDOK NORTH STREET 5
                                                                                ...
                                                                                SINGAPORE 486121</p>
                                                                            <hr>
                                                                            <label for="" class="mb-0">Cleaning
                                                                                Details</label>

                                                                            <!-- <p class="m-0">Self Collection</p> -->

                                                                            <p class="m-0">Deposite Type : Wave</p>
                                                                            <p class="m-0">Date Of Cleaning : 25/04/2023
                                                                            </p>
                                                                            <p class="m-0">Time Of Cleaning : 05:47 PM
                                                                            </p>
                                                                ...
                                                                <div class="col-md-9 pe-0">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div
                                                                                class="card box-shadow card-rounded text-left">
                                                                                <div class="card-body">
                                                                                    <label for=""
                                                                                        class="mb-0">Customer
                                                                                        Details</label>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-md-7">
                                                                                            <p class="m-0">Total (before
                                                                                                tax):</p>
                                                                                            <p class="m-0">Total Tax:
                                                                                            </p>
                                                                                            <p class="m-0">Total
                                                                                                Discount:</p>
                                                                                            <h6>Grand Total:</h6>
                        ...
                        <div class="lead-column">
                            ...
                            <div class="card-body">
                                <div class="lead-card">
                                    ...
                                    <button class="btn btn-primary ripple" type="button" data-bs-toggle="modal"
                                        data-bs-target="#update-status" data-whatever="@getbootstrap">
